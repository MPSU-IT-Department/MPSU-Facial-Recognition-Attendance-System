...
class FacialRecognitionApp:
    ...
    def handle_remote_session_end(self, notice=None):
        ...
        # Suppress the extra popup here to avoid duplicate dialogs.
        # The parent handler will display the class/session summary instead.
        try:
            print(f"INFO: Remote session ended: {message}")
        except Exception:
            pass
        try:
            self.shutdown(destroy_root=False)
